...
*/
class TX_API TiXmlNode : public TiXmlBase
{
	friend class TiXmlDocument;
	friend class TiXmlElement;
...
*/
class TX_API TiXmlAttribute : public TiXmlBase
{
...
*/
class TX_API TiXmlElement : public TiXmlNode
{
public:
...
*/
class TX_API TiXmlDocument : public TiXmlNode
{
public:
